...
$(document).ready(function () {
	$('a.donate').on('click', function (event) {
		alertify.alert('Efectue uma doação!',
			'<p>Muito obrigado pelo seu apoio!</p>' +
			'<p>Qualquer ajuda é muito bem-vinda.</p>' +
			'<p>A Associação não tem fins lucrativos e, por ser uma IPSS, as contribuições podem ser deduzidas, nos termos da legislação aplicável, em sede de impostos.</p>' +
			'<br /><br />' +
			'<p>Informação para transferência:</p>' +
			'<p><b>Banco:</b> BPI</p>' +
			'<p><b>IBAN:</b> PT50 0036 0000 99100000000 85</p>' +
			'<p><b>BIC/SWIFT:</b> BBPIPTPL</p>' +
			'<br />' +
			'<div style="text-align: center;">' +
			'<img src="assets/images/qr-code.png" alt="QR Code para Doação" style="max-width: 100%; height: auto;"><br />' +
			'</div>' +
			'Por favor envie-nos um comprovativo da sua doação para: somosnos@somosnos.pt' +
			'<br />Indique no email o seu <b>nome, NIF e morada</b> para emissão de recibo.'
		);
	});
});
